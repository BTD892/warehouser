...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        self.BusinessArgs = {"domain": "iat", "language": "zh_cn", "accent": "minnanese", "vinfo": 1, "vad_eos": 10000}
...
if __name__ == "__main__":
    # 测试时候在此处正确填写相关信息即可运行
    time1 = datetime.now()
    ffmpeg.input(r'C:\Users\16025\Desktop\port\mintest3.m4a').output(r'C:\Users\16025\Desktop\port\mintest6.pcm', ar=8000).run()
    wsParam = Ws_Param(APPID='4e466cce', APISecret='N2Q4NzBlOTg5MTZiMjIyNTMzZTE2MTVm',
                       APIKey='d682336b77e5399da489a0db64d40ac0',
                       AudioFile=r'C:\Users\16025\Desktop\port\mintest6.pcm')
